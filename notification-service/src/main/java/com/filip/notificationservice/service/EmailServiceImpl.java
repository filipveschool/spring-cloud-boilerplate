...
public class EmailServiceImpl implements EmailService {
    ...
    public void send(NotificationType type, Recipient recipient, String attachment) throws MessagingException, IOException {
        ...
        final String text = MessageFormat.format(Objects.requireNonNull(env.getProperty(type.getText())), recipient.getAccountName());
        ...
        if (StringUtils.hasLength(attachment)) {
            helper.addAttachment(Objects.requireNonNull(env.getProperty(type.getAttachment())), new ByteArrayResource(attachment.getBytes()));
        }
